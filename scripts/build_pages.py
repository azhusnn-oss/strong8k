...
def build_home():
    ...
    s.append(sec(
        section_head("3. What Is Included", "What You Get With Strong 8K IPTV", None)
...
def build_legal():
    ...
    dmca = f"""<div class="legal-section" id="dmca">
      ...
      <p>Strong 8K IPTV respects the intellectual property rights of others and expects users of
      the website at https://{DOMAIN}/ to do the same. We respond to notices of alleged copyright
...
PAGES = [
    ("index.html", "Strong 8K IPTV | UK IPTV Subscription From £14.99",
     "Strong 8K IPTV brings 40,000+ live channels, sports, movies and VOD in HD, 4K and 8K to every device. Plans from £14.99 with a free 24-hour trial.",
     "index.html", build_home),
    ("iptv-subscription.html", "IPTV Subscription Plans From £14.99 | Strong 8K IPTV",
     "Compare Strong 8K IPTV subscription plans from £14.99. Choose 1, 3, 6 or 12 months of live TV, sports and VOD, and save up to 67% on the annual plan.",
     "iptv-subscription.html", build_subscription),
    ("strong-8k-app.html", "Strong 8K App & IPTV Player: Download and Setup Guide",
     "Download the Strong 8K app or set up a compatible IPTV player. Get Downloader code 1646512, supported devices, and M3U or Xtream Codes login help.",
     "strong-8k-app.html", build_app_player),
    ("strong-8k-iptv-installation.html", "IPTV Installation Guide: Firestick, Android TV & More",
     "Step-by-step IPTV installation for Firestick, Android TV, Smart TV and IPTV boxes. Use Downloader code 1646512 plus M3U and Xtream Codes setup help.",
     "strong-8k-iptv-installation.html", build_installation),
    ("strong-8k-reseller-panel.html", "IPTV Reseller Panel: Credits & White Label | Strong 8K",
     "Start selling with the Strong 8K IPTV reseller panel. Pick 120, 360 or 1,000 credit packages, manage customers and sell under your own brand.",
     "strong-8k-reseller-panel.html", build_reseller),
    ("contact-us.html", "Contact Strong 8K IPTV Support | WhatsApp & Email Help",
     "Get Strong 8K IPTV support on WhatsApp or by email. Help with subscriptions, setup, troubleshooting, reseller accounts and starting a free trial.",
     "contact-us.html", build_contact),
    ("legal.html", "Strong 8K IPTV Legal: DMCA, Privacy, Terms & Refunds",
     "Read the Strong 8K IPTV legal information: DMCA policy, privacy policy, terms and conditions, and our 7-day refund policy, all on one page.",
